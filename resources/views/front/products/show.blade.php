            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    ...
                    <div class="ps-product__info">
                        ...
                        <h1>{{ $product->name }}</h1>
                        <p class="ps-product__category">{{ $product->category ? $product->category->name : '' }}</p>
                        ...
                        <form action="{{ route('cart.store') }}" method="post" id="add-to-cart">
                            ...
                            <div class="ps-product__block ps-product__size">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="quantity" type="number" value="2">
                                </div>
                            </div>
                            <div class="ps-product__shopping">
                                <button type="submit" class="ps-btn mb-10">Add to cart<i class="ps-icon-next"></i>
                                </button>
